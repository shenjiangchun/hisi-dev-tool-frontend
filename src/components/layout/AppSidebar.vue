...
import { Document, Share, Folder, Cpu, Monitor } from '@element-plus/icons-vue'
...
type MenuKey = 'call-chain' | 'log-analysis' | 'ops' | 'project-management' | 'mcp-guide' | 'claude-terminal'
